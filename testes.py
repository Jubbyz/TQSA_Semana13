...
class TurmaTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.alunos = []
        self.alunos.append(Aluno('Fernanda', 'Torres', 11))
        self.alunos.append(Aluno('Jade', 'Maria', 7))
        self.alunos.append(Aluno('Gian', 'Carlo', 8))
        self.alunos.append(Aluno('Joao', 'Victor', 9))
        self.alunos.append(Aluno('Paulo', 'Santos', 6))
